...
export type RelationshipType = "depends_on" | "constrains" | "implements" | "references" | "produces";
...
export const SAAS_APP: Template = {
  label: "SaaS App",
  ...
  edges: [
    { source: "overview", target: "feature", relationship: "depends_on" },
    { source: "rules", target: "feature", relationship: "constrains" },
    { source: "rules", target: "arch", relationship: "constrains" },
    { source: "feature", target: "arch", relationship: "depends_on" },
    { source: "arch", target: "db", relationship: "implements" },
    { source: "arch", target: "api", relationship: "implements" },
    { source: "feature", target: "ui", relationship: "depends_on" },
    { source: "arch", target: "deploy", relationship: "depends_on" },
    { source: "feature", target: "test", relationship: "produces" },
  ],
};

export const CLI_TOOL: Template = {
  label: "CLI Tool",
...
export const API_SERVICE: Template = {
  label: "API Service",
...
export const TEMPLATE_META = Object.entries(TEMPLATES).map(([key, value]) => ({
  id: key,
  label: value.label,
